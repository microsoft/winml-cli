...
| ahotrod/electra_large_discriminator_squad2_512 | question-answering | 8/9 |
| apple/mobilevit-small | image-classification | 8/9 |
...
| dima806/fairface_age_image_detection | image-classification | 2/9 |
| distilbert/distilbert-base-cased-distilled-squad | question-answering | 8/9 |
| distilbert/distilbert-base-uncased | fill-mask | 8/9 |
| distilbert/distilbert-base-uncased-distilled-squad | question-answering | 8/9 |
| distilbert/distilbert-base-uncased-finetuned-sst-2-english | text-classification | 8/9 |
...
| google-bert/bert-base-multilingual-cased | fill-mask | 7/9 |
...
| kredor/punctuate-all | token-classification | 8/9 |
| laion/CLIP-ViT-B-32-laion2B-s34B-b79K | feature-extraction | 9/9 |
| laion/CLIP-ViT-B-32-laion2B-s34B-b79K | zero-shot-image-classification | 1/9 |
| lxyuan/distilbert-base-multilingual-cased-sentiments-student | zero-shot-classification | 8/9 |
| microsoft/rad-dino | image-feature-extraction | 9/9 |
| microsoft/resnet-18 | image-classification | 8/9 |
| monologg/koelectra-small-v2-distilled-korquad-384 | question-answering | 8/9 |
...
| sentence-transformers/all-mpnet-base-v2 | feature-extraction | 8/9 |
| sentence-transformers/all-mpnet-base-v2 | fill-mask | 8/9 |
| sentence-transformers/all-mpnet-base-v2 | sentence-similarity | 8/9 |
| sentence-transformers/multi-qa-mpnet-base-dot-v1 | feature-extraction | 8/9 |
| sentence-transformers/multi-qa-mpnet-base-dot-v1 | fill-mask | 7/9 |
| sentence-transformers/multi-qa-mpnet-base-dot-v1 | sentence-similarity | 8/9 |
...
| valentinafeve/yolos-fashionpedia | object-detection | 8/9 |
