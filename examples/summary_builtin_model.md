...
Total: **53** (model, task) tuples.

| Model | Task | EPs Passed |
|---|---|---|
| BAAI/bge-large-en-v1.5 | sentence-similarity | 9/9 |
| BAAI/bge-small-en-v1.5 | feature-extraction | 6/9 |
| BAAI/bge-small-en-v1.5 | sentence-similarity | 9/9 |
| FacebookAI/roberta-base | fill-mask | 8/9 |
| FacebookAI/xlm-roberta-base | fill-mask | 5/9 |
| Isotonic/distilbert_finetuned_ai4privacy_v2 | token-classification | 4/9 |
| ahotrod/electra_large_discriminator_squad2_512 | question-answering | 9/9 |
| apple/mobilevit-small | image-classification | 9/9 |
...
| dima806/fairface_age_image_detection | image-classification | 4/9 |
| distilbert/distilbert-base-cased-distilled-squad | question-answering | 9/9 |
| distilbert/distilbert-base-uncased | fill-mask | 9/9 |
| distilbert/distilbert-base-uncased-distilled-squad | question-answering | 9/9 |
| distilbert/distilbert-base-uncased-finetuned-sst-2-english | text-classification | 9/9 |
| facebook/dino-vitb16 | image-feature-extraction | 9/9 |
| facebook/dino-vits16 | image-feature-extraction | 9/9 |
...
| google-bert/bert-base-multilingual-cased | feature-extraction | 6/9 |
| google-bert/bert-base-multilingual-cased | fill-mask | 8/9 |
| google-bert/bert-base-multilingual-uncased | fill-mask | 6/9 |
| google-bert/bert-base-uncased | fill-mask | 8/9 |
| google/vit-base-patch16-224 | image-classification | 9/9 |
| google/vit-base-patch16-224-in21k | image-feature-extraction | 9/9 |
| hustvl/yolos-small | object-detection | 7/9 |
| kredor/punctuate-all | token-classification | 9/9 |
| laion/CLIP-ViT-B-32-laion2B-s34B-b79K | feature-extraction | 9/9 |
| laion/CLIP-ViT-B-32-laion2B-s34B-b79K | zero-shot-image-classification | 2/9 |
| lxyuan/distilbert-base-multilingual-cased-sentiments-student | zero-shot-classification | 9/9 |
| microsoft/rad-dino | image-feature-extraction | 9/9 |
| microsoft/resnet-18 | image-classification | 9/9 |
| monologg/koelectra-small-v2-distilled-korquad-384 | question-answering | 9/9 |
| openai/clip-vit-base-patch16 | feature-extraction | 9/9 |
| openai/clip-vit-base-patch32 | feature-extraction | 8/9 |
| openai/clip-vit-base-patch32 | zero-shot-image-classification | 5/9 |
| rizvandwiki/gender-classification | image-classification | 5/9 |
...
| sentence-transformers/all-mpnet-base-v2 | feature-extraction | 9/9 |
| sentence-transformers/all-mpnet-base-v2 | fill-mask | 9/9 |
| sentence-transformers/all-mpnet-base-v2 | sentence-similarity | 9/9 |
| sentence-transformers/multi-qa-mpnet-base-dot-v1 | feature-extraction | 9/9 |
| sentence-transformers/multi-qa-mpnet-base-dot-v1 | fill-mask | 8/9 |
| sentence-transformers/multi-qa-mpnet-base-dot-v1 | sentence-similarity | 9/9 |
| sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 | feature-extraction | 5/9 |
| sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 | sentence-similarity | 9/9 |
| sentence-transformers/paraphrase-multilingual-mpnet-base-v2 | sentence-similarity | 8/9 |
| valentinafeve/yolos-fashionpedia | object-detection | 9/9 |
| w11wo/indonesian-roberta-base-posp-tagger | token-classification | 5/9 |
