...
|  | zero-shot-image-classification |  | [config](./laion_CLIP-ViT-B-32-laion2B-s34B-b79K/zero-shot-image-classification_config_image-encoder.json) | — |
...
|  | zero-shot-image-classification |  | [config](./openai_clip-vit-base-patch32/zero-shot-image-classification_config_image-encoder.json) | top1_accuracy=58.4000, top5_accuracy=84.0000 ([metric](./openai_clip-vit-base-patch32/zero-shot-image-classification_eval_result.json)) |
...
| rizvandwiki/gender-classification | image-classification |  | [config](./rizvandwiki_gender-classification/image-classification_config.json) | accuracy=0.8500 ([metric](./rizvandwiki_gender-classification/image-classification_eval_result.json)) |
...
| w11wo/indonesian-roberta-base-posp-tagger | token-classification |  | [config](./w11wo_indonesian-roberta-base-posp-tagger/token-classification_config.json) | overall_precision=0.9680, overall_recall=0.9680, overall_f1=0.9680, overall_accuracy=0.9680 ([metric](./w11wo_indonesian-roberta-base-posp-tagger/token-classification_eval_result.json)) |
