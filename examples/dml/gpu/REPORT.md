...
| google-bert/bert-base-uncased | fill-mask |  | [config](./google-bert_bert-base-uncased/fill-mask_config.json) | TIMEOUT |
...
|  | zero-shot-image-classification |  | [config](./openai_clip-vit-base-patch32/zero-shot-image-classification_config_image-encoder.json) | TIMEOUT |
