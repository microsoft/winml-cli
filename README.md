...
Dev installs (`pip install -e .` or running from a source checkout) never send
telemetry.
...
Telemetry is automatically disabled in CI / non-TTY environments regardless of the
stored decision.
