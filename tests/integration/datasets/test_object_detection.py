...
class TestObjectDetectionDatasetDeriveOverrides:
    ...
    def test_no_io_config_returns_empty_overrides(self, dataset_class: type) -> None:
    ...
    def test_sets_do_pad_false_when_no_pixel_mask(self, dataset_class: type) -> None:
    ...
    def test_does_not_set_do_pad_when_pixel_mask_present(self, dataset_class: type) -> None:
    ...
    def test_handles_partial_dynamic_dimensions(self, dataset_class: type) -> None:
