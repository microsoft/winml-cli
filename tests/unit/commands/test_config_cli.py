...
def mock_resolve_device():
    """Mock resolve_device_category to avoid hardware detection in all config CLI tests.

    The config command may call resolve_device_category() for device/precision resolution.
