...
def test_build_session_options_allows_monitor_to_configure_native_options(
    qnn_npu: WinMLEPDevice,
) -> None:
    """A monitor can configure SessionOptions attributes that are not config entries."""
