...
class TestResolveTask:
    ...
    def test_canonical_feature_extraction_translated_for_vision_model(self):
        """Vision FE model with --task feature-extraction gets translated to
        image-feature-extraction so the evaluator registry lookup succeeds."""
        from winml.modelkit.eval.evaluate import _resolve_task
