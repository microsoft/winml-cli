...
class TestFusionIntegration:
    ...
    def test_all_fusions_combined(self, decomposed_layernorm_model: onnx.ModelProto) -> None:
    ...
    def test_no_fusion_when_pattern_not_present(self) -> None:
        ...
        input_tensor = helper.make_tensor_value_info("input", TensorProto.FLOAT, [1, 10, 64])
    ...
    def test_fusion_isolation(self, bert_attention_model: onnx.ModelProto) -> None:
