...
class TestOptimizeOnnxErrorTypes:
    ...
    def test_configuration_error_on_invalid_config(self, model_file: Path, tmp_path: Path) -> None:
...
class TestOptimizeOnnxIntegration:
    ...
    def test_end_to_end_basic(self, all_patterns_model: onnx.ModelProto, tmp_path: Path) -> None:
    ...
    def test_model_proto_passthrough(self, all_patterns_model: onnx.ModelProto) -> None:
    ...
    def test_returns_optimized_model(self, all_patterns_model: onnx.ModelProto) -> None:
