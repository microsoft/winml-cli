...
class TestORTFusionPipeBuildConfig:
    ...
    def test_build_config_multiple_fusions(self, fusion_capabilities: dict) -> None:
        ...
        config = ORTFusionPipe.build_config(
            attention_fusion=True, layer_norm_fusion=True
        )
    ...
    def test_build_config_respects_capability_defaults(
        self, fusion_capabilities: dict
    ) -> None:
    ...
    def test_build_config_with_model_type_and_fusions(
        self, fusion_capabilities: dict
    ) -> None:
...
class TestORTFusionPipeShouldProcess:
    ...
    def test_should_process_returns_true_with_multiple_fusions(self) -> None:
        ...
        """
        config = ORTFusionPipeConfig(
            enable_attention=True, enable_layer_norm=True
        )
    ...
    def test_should_process_checks_all_fusion_options(self) -> None:
        ...
        for option_name in all_options:
            ...
            assert (
                ORTFusionPipe.should_process(test_config) is True
...
class TestORTFusionPipeEdgeCases:
    ...
    def test_build_config_with_all_fusions_enabled(
        self, fusion_capabilities: dict
    ) -> None:
    ...
    def test_build_config_with_different_model_types(
        self, fusion_capabilities: dict
    ) -> None:
    ...
    def test_process_passthrough_when_no_fusions(
...
class TestAttentionOpType:
    ...
    def test_self_attention_model_structure(
...
class TestGroupNormChannelsLast:
    ...
    def test_groupnorm_model_structure(self, groupnorm_model: onnx.ModelProto) -> None:
        ...
        reducemean_count = sum(
            1 for n in groupnorm_model.graph.node if n.op_type == "ReduceMean"
        )
    ...
    def test_groupnorm_channels_last_layout(
        self, groupnorm_model: onnx.ModelProto
    ) -> None:
