...
class TestOptimizerPipeFailure:
    ...
    def test_pipe_processing_failure_raises(
        self, simple_model: onnx.ModelProto
    ) -> None:
...
class TestOptimizerNoPostValidation:
    ...
    def test_no_post_validation_check(
        self, simple_model: onnx.ModelProto
    ) -> None:
...
class TestOptimizerResolveDependencies:
    ...
    def test_resolve_dependencies_uses_defaults(
        self, simple_model: onnx.ModelProto
    ) -> None:
    ...
    def test_resolve_dependencies_partial_kwargs(
        self, simple_model: onnx.ModelProto
    ) -> None:
...
class TestShapeInferenceFallback:
    ...
    def test_symbolic_failure_falls_back_to_onnx(
        self, simple_model: onnx.ModelProto
    ) -> None:
    ...
    def test_both_inference_failures_returns_original(
        self, simple_model: onnx.ModelProto
    ) -> None:
    ...
    def test_symbolic_success_skips_onnx(
        self, simple_model: onnx.ModelProto
    ) -> None:
...
class TestOptimizerPipeSkipping:
    ...
    def test_pipe_skipped_when_no_capabilities(
        self, simple_model: onnx.ModelProto
    ) -> None:
