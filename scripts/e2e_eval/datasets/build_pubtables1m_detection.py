...
_DEFAULT_CACHE_DIR = Path.home() / ".cache" / "winml" / "eval_datasets" / "build_pubtables1m_detection"


def main() -> None:
    parser = argparse.ArgumentParser(description="Build PubTables-1M detection dataset")
    parser.add_argument("--output", type=Path, default=None, help="Output directory (default: ~/.cache/winml/eval_datasets/build_pubtables1m_detection)")
