...
| `winml_manifest.json` | Build/export provenance with stage timings. Generated by `winml build`, `winml export`, and the Python API (`build_hf_model`/`build_onnx_model`). |
