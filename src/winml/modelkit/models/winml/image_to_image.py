...
Thin wrapper for image-to-image inference (super-resolution, denoising,
JPEG-artifact removal, etc.). Pipeline execution (export/optimize/compile)
is done by WinMLAutoModel factory.
"""
